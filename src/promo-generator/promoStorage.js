...
const normalizePromoFormatSettings = (project = {}) => ({
  ...
  showCtaBadge: project.showCtaBadge === undefined ? DEFAULT_PROMO_FORMAT_SETTINGS.showCtaBadge : Boolean(project.showCtaBadge),
  ctaBadgeColor: normalizeColor(project.ctaBadgeColor, DEFAULT_PROMO_FORMAT_SETTINGS.ctaBadgeColor),
