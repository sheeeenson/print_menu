...
export function SiteBannerPreview({ dish, settings, index = 0 }) {
  ...
  return (
    <section className="site-banner-preview-shell" aria-label="Sushiwoki website banner preview">
      <div className="site-banner-canvas-wrap" style={{ width: `${SITE_BANNER_FORMAT.previewWidth}px`, aspectRatio: `${SITE_BANNER_FORMAT.width} / ${SITE_BANNER_FORMAT.height}` }}>
      ...
      <small className="site-banner-preview-size">Output canvas: {SITE_BANNER_FORMAT.width} × {SITE_BANNER_FORMAT.height}px</small>
    </section>
  );
}
